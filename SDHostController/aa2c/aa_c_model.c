...
// if statement :  file .Aa/sdhc.linked.aa, line -1044844768
...
// if statement :  file .Aa/sdhc.linked.aa, line 25425280
...
// if statement :  file .Aa/sdhc.linked.aa, line 25205504
...
// if statement :  file .Aa/sdhc.linked.aa, line -1044845408
...
// merge  file .Aa/sdhc.linked.aa, line 1252
_sdhc_daemon_merge_stmt_3595_c_preamble_macro_; 
_sdhc_daemon_merge_stmt_3595_c_postamble_macro_; 
// 			waitReady := ready $buffering 1// bits of buffering = 1. 
_sdhc_daemon_assign_stmt_3598_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(EQ_u1_u1_3602,1);\
bit_vector_equal(0, &(waitReady), &(ZERO_1), &(EQ_u1_u1_3602));\
if (has_undefined_bit(&EQ_u1_u1_3602)) {fprintf(stderr, "Error: variable EQ_u1_u1_3602 has undefined value (%s) at test point.\n", to_string(&EQ_u1_u1_3602));assert(0);} \

if (bit_vector_to_uint64(0, &EQ_u1_u1_3602)) { 
/* 			$place[waitloopforready]
*/  goto waitloopforready_3433;
} 
else {
 ;
}
// merge  file .Aa/sdhc.linked.aa, line 1258
_sdhc_daemon_merge_stmt_3605_c_preamble_macro_; 
_sdhc_daemon_merge_stmt_3605_c_postamble_macro_; 
// 			waitReady8clocks := ready8clocks $buffering 1// bits of buffering = 1. 
_sdhc_daemon_assign_stmt_3608_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(EQ_u1_u1_3612,1);\
bit_vector_equal(0, &(waitReady8clocks), &(ZERO_1), &(EQ_u1_u1_3612));\
if (has_undefined_bit(&EQ_u1_u1_3612)) {fprintf(stderr, "Error: variable EQ_u1_u1_3612 has undefined value (%s) at test point.\n", to_string(&EQ_u1_u1_3612));assert(0);} \

if (bit_vector_to_uint64(0, &EQ_u1_u1_3612)) { 
/* 			$place[waitloopfor8clocks]
*/  goto waitloopfor8clocks_3433;
} 
else {
 ;
}
// 			readyClockCountEnable := ZERO_1 $buffering 1// bits of buffering = 1. 
_sdhc_daemon_assign_stmt_3617_c_macro_; 
...
_sdhc_daemon_call_stmt_3624_c_macro_; 
// 			readyClockCountEnable := ONE_1 $buffering 1// bits of buffering = 1. 
_sdhc_daemon_assign_stmt_3627_c_macro_; 
// 			normalInterruptFlag1 := _hFF  $buffering 1// bits of buffering = 8. 
_sdhc_daemon_assign_stmt_3630_c_macro_; 
// 			normalInterruptFlag2 := _hFF  $buffering 1// bits of buffering = 8. 
_sdhc_daemon_assign_stmt_3633_c_macro_; 
// 			errorInterruptFlag1 := _hFF  $buffering 1// bits of buffering = 8. 
_sdhc_daemon_assign_stmt_3636_c_macro_; 
// 			errorInterruptFlag2 := _hFF  $buffering 1// bits of buffering = 8. 
_sdhc_daemon_assign_stmt_3639_c_macro_; 
} 
else {
 ;
}
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(konst_3643,10);\
bit_vector_clear(&konst_3643);\
__declare_static_bit_vector(UGT_u10_u1_3644,1);\
bit_vector_clear(&konst_3643);\
bit_vector_greater(0, &(rxBufferPointer), &(konst_3643), &(UGT_u10_u1_3644));\
if (has_undefined_bit(&UGT_u10_u1_3644)) {fprintf(stderr, "Error: variable UGT_u10_u1_3644 has undefined value (%s) at test point.\n", to_string(&UGT_u10_u1_3644));assert(0);} \

if (bit_vector_to_uint64(0, &UGT_u10_u1_3644)) { 
// 			$call readSDHCRegisters (37  ) (tempPresentState_1_1 ) 
_sdhc_daemon_call_stmt_3647_c_macro_; 
// 			$call writeSDHCRegisters (37  (tempPresentState_1_1 | _h08 ) ) () 
_sdhc_daemon_call_stmt_3652_c_macro_; 
// 			bufferReadReady := (ZERO_8 | _h20 ) $buffering 1// bits of buffering = 8. 
_sdhc_daemon_assign_stmt_3657_c_macro_; 
// 			normalInterruptFlag1 := (normalInterruptFlag1 | _h20 ) $buffering 1// bits of buffering = 8. 
_sdhc_daemon_assign_stmt_3662_c_macro_; 
} 
else {
 ;
}
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(konst_3666,10);\
bit_vector_clear(&konst_3666);\
konst_3666.val.byte_array[1] = 2;\
__declare_static_bit_vector(ULT_u10_u1_3667,1);\
bit_vector_clear(&konst_3666);\
konst_3666.val.byte_array[1] = 2;\
bit_vector_less(0, &(txBufferPointer), &(konst_3666), &(ULT_u10_u1_3667));\
if (has_undefined_bit(&ULT_u10_u1_3667)) {fprintf(stderr, "Error: variable ULT_u10_u1_3667 has undefined value (%s) at test point.\n", to_string(&ULT_u10_u1_3667));assert(0);} \

if (bit_vector_to_uint64(0, &ULT_u10_u1_3667)) { 
// 			$call readSDHCRegisters (37  ) (tempPresentState_1_2 ) 
_sdhc_daemon_call_stmt_3670_c_macro_; 
// 			$call writeSDHCRegisters (37  (tempPresentState_1_2 | _h04 ) ) () 
_sdhc_daemon_call_stmt_3675_c_macro_; 
// 			bufferWriteReady := (ZERO_8 | _h10 ) $buffering 1// bits of buffering = 8. 
_sdhc_daemon_assign_stmt_3680_c_macro_; 
// 			normalInterruptFlag1 := (normalInterruptFlag1 | _h10 ) $buffering 1// bits of buffering = 8. 
_sdhc_daemon_assign_stmt_3685_c_macro_; 
} 
else {
 ;
}
// 			$volatile bufferDataPortCheck := (address == 32 ) $buffering 1
_sdhc_daemon_assign_stmt_3691_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(konst_3694,1);\
bit_vector_clear(&konst_3694);\
konst_3694.val.byte_array[0] = 1;\
__declare_static_bit_vector(EQ_u1_u1_3695,1);\
__declare_static_bit_vector(konst_3697,10);\
bit_vector_clear(&konst_3697);\
konst_3697.val.byte_array[1] = 2;\
__declare_static_bit_vector(ULT_u10_u1_3698,1);\
__declare_static_bit_vector(AND_u1_u1_3699,1);\
bit_vector_clear(&konst_3694);\
konst_3694.val.byte_array[0] = 1;\
bit_vector_equal(0, &(bufferDataPortCheck), &(konst_3694), &(EQ_u1_u1_3695));\
bit_vector_clear(&konst_3697);\
konst_3697.val.byte_array[1] = 2;\
bit_vector_less(0, &(txBufferPointer), &(konst_3697), &(ULT_u10_u1_3698));\
bit_vector_and(&(EQ_u1_u1_3695), &(ULT_u10_u1_3698), &(AND_u1_u1_3699));\
if (has_undefined_bit(&AND_u1_u1_3699)) {fprintf(stderr, "Error: variable AND_u1_u1_3699 has undefined value (%s) at test point.\n", to_string(&AND_u1_u1_3699));assert(0);} \

if (bit_vector_to_uint64(0, &AND_u1_u1_3699)) { 
// merge  file .Aa/sdhc.linked.aa, line 1286
_sdhc_daemon_merge_stmt_3700_c_preamble_macro_; 
// 				$phi B := 				  ($bitcast ($uint<8>) 0  ) $on   $entry 				  next_B $on   loopBuffer 
 // type of target is $uint<8>
_sdhc_daemon_phi_stmt_3701_c_macro_; 
_sdhc_daemon_merge_stmt_3700_c_postamble_macro_; 
...
_sdhc_daemon_assign_stmt_3714_c_macro_; 
// 			$volatile next_B := (B + 1 ) $buffering 1
_sdhc_daemon_assign_stmt_3719_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(konst_3722,8);\
bit_vector_clear(&konst_3722);\
konst_3722.val.byte_array[0] = 4;\
__declare_static_bit_vector(ULT_u8_u1_3723,1);\
bit_vector_clear(&konst_3722);\
konst_3722.val.byte_array[0] = 4;\
bit_vector_less(0, &(next_B), &(konst_3722), &(ULT_u8_u1_3723));\
if (has_undefined_bit(&ULT_u8_u1_3723)) {fprintf(stderr, "Error: variable ULT_u8_u1_3723 has undefined value (%s) at test point.\n", to_string(&ULT_u8_u1_3723));assert(0);} \

if (bit_vector_to_uint64(0, &ULT_u8_u1_3723)) { 
/* 			$place[loopBuffer]
...
_sdhc_daemon_assign_stmt_3730_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(konst_3733,10);\
bit_vector_clear(&konst_3733);\
konst_3733.val.byte_array[1] = 2;\
__declare_static_bit_vector(EQ_u10_u1_3734,1);\
bit_vector_clear(&konst_3733);\
konst_3733.val.byte_array[1] = 2;\
bit_vector_equal(0, &(txBufferPointer), &(konst_3733), &(EQ_u10_u1_3734));\
if (has_undefined_bit(&EQ_u10_u1_3734)) {fprintf(stderr, "Error: variable EQ_u10_u1_3734 has undefined value (%s) at test point.\n", to_string(&EQ_u10_u1_3734));assert(0);} \

if (bit_vector_to_uint64(0, &EQ_u10_u1_3734)) { 
// 			$call readSDHCRegisters (37  ) (tempPresentState_1_3 ) 
_sdhc_daemon_call_stmt_3737_c_macro_; 
// 			$call writeSDHCRegisters (37  (tempPresentState_1_3 | _hfb ) ) () 
_sdhc_daemon_call_stmt_3742_c_macro_; 
// 			$call readSDHCRegisters (12  ) (transferRegVal ) 
_sdhc_daemon_call_stmt_3745_c_macro_; 
// 			singleMultipleBlock := (  $bitreduce |  (transferRegVal & _h20 ) ) $buffering 1// bits of buffering = 1. 
_sdhc_daemon_assign_stmt_3751_c_macro_; 
// 			blockCountEnable := ((  $bitreduce |  (transferRegVal & _h02 ) ) & singleMultipleBlock) $buffering 1// bits of buffering = 1. 
_sdhc_daemon_assign_stmt_3759_c_macro_; 
// merge  file .Aa/sdhc.linked.aa, line 1303
_sdhc_daemon_merge_stmt_3760_c_preamble_macro_; 
// 				$phi C := 				  ONE_8 $on   $entry 				  next_C $on   loopBlock 
 // type of target is $uint<8>
_sdhc_daemon_phi_stmt_3761_c_macro_; 
// 				$phi newBlockCount := 				  ($bitcast ($uint<16>) 0  ) $on   $entry 				  blockCount $on   loopBlock 
 // type of target is $uint<16>
_sdhc_daemon_phi_stmt_3765_c_macro_; 
_sdhc_daemon_merge_stmt_3760_c_postamble_macro_; 
// 			$call readSDHCRegisters ((6  + C) ) (newBlockCountTemp ) 
_sdhc_daemon_call_stmt_3775_c_macro_; 
// 			$volatile blockCount := (( $slice newBlockCount 7 0 )  && newBlockCountTemp) $buffering 1
_sdhc_daemon_assign_stmt_3781_c_macro_; 
// 			$volatile next_C := (C - 1 ) $buffering 1
_sdhc_daemon_assign_stmt_3786_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(konst_3789,8);\
bit_vector_clear(&konst_3789);\
__declare_static_bit_vector(NEQ_u8_u1_3790,1);\
bit_vector_clear(&konst_3789);\
bit_vector_not_equal(0, &(C), &(konst_3789), &NEQ_u8_u1_3790);\
if (has_undefined_bit(&NEQ_u8_u1_3790)) {fprintf(stderr, "Error: variable NEQ_u8_u1_3790 has undefined value (%s) at test point.\n", to_string(&NEQ_u8_u1_3790));assert(0);} \

if (bit_vector_to_uint64(0, &NEQ_u8_u1_3790)) { 
/* 			$place[loopBlock]
*/  goto loopBlock_3433;
} 
else {
...
_sdhc_daemon_assign_stmt_3837_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(konst_3840,1);\
bit_vector_clear(&konst_3840);\
konst_3840.val.byte_array[0] = 1;\
__declare_static_bit_vector(EQ_u1_u1_3841,1);\
__declare_static_bit_vector(konst_3843,10);\
bit_vector_clear(&konst_3843);\
__declare_static_bit_vector(NEQ_u10_u1_3844,1);\
__declare_static_bit_vector(AND_u1_u1_3845,1);\
bit_vector_clear(&konst_3840);\
konst_3840.val.byte_array[0] = 1;\
bit_vector_equal(0, &(readBufferDataPortCheck), &(konst_3840), &(EQ_u1_u1_3841));\
bit_vector_clear(&konst_3843);\
bit_vector_not_equal(0, &(rxBufferPointer), &(konst_3843), &NEQ_u10_u1_3844);\
bit_vector_and(&(EQ_u1_u1_3841), &(NEQ_u10_u1_3844), &(AND_u1_u1_3845));\
if (has_undefined_bit(&AND_u1_u1_3845)) {fprintf(stderr, "Error: variable AND_u1_u1_3845 has undefined value (%s) at test point.\n", to_string(&AND_u1_u1_3845));assert(0);} \

if (bit_vector_to_uint64(0, &AND_u1_u1_3845)) { 
// merge  file .Aa/sdhc.linked.aa, line 1327
_sdhc_daemon_merge_stmt_3846_c_preamble_macro_; 
// 				$phi D := 				  ($bitcast ($uint<8>) 0  ) $on   $entry 				  next_D $on   loopBufferWrite 
 // type of target is $uint<8>
_sdhc_daemon_phi_stmt_3847_c_macro_; 
_sdhc_daemon_merge_stmt_3846_c_postamble_macro_; 
// 			tempBuf2 := dataBufferRx $buffering 1// bits of buffering = 8. 
_sdhc_daemon_assign_stmt_3855_c_macro_; 
// 			$call writeSDHCRegisters ((32  + D) tempBuf2 ) () 
_sdhc_daemon_call_stmt_3860_c_macro_; 
// 			$volatile next_D := (D + 1 ) $buffering 1
_sdhc_daemon_assign_stmt_3865_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(konst_3868,8);\
bit_vector_clear(&konst_3868);\
konst_3868.val.byte_array[0] = 4;\
__declare_static_bit_vector(ULT_u8_u1_3869,1);\
bit_vector_clear(&konst_3868);\
konst_3868.val.byte_array[0] = 4;\
bit_vector_less(0, &(next_D), &(konst_3868), &(ULT_u8_u1_3869));\
if (has_undefined_bit(&ULT_u8_u1_3869)) {fprintf(stderr, "Error: variable ULT_u8_u1_3869 has undefined value (%s) at test point.\n", to_string(&ULT_u8_u1_3869));assert(0);} \

if (bit_vector_to_uint64(0, &ULT_u8_u1_3869)) { 
...
_sdhc_daemon_assign_stmt_3876_c_macro_; 
// 			$call readSDHCRegisters (12  ) (transferRegVal2 ) 
_sdhc_daemon_call_stmt_3879_c_macro_; 
// 			singleMultipleReadBlock := (  $bitreduce |  (transferRegVal2 & _h20 ) ) $buffering 1// bits of buffering = 1. 
_sdhc_daemon_assign_stmt_3885_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(konst_3888,10);\
bit_vector_clear(&konst_3888);\
__declare_static_bit_vector(EQ_u10_u1_3889,1);\
bit_vector_clear(&konst_3888);\
bit_vector_equal(0, &(rxBufferPointer), &(konst_3888), &(EQ_u10_u1_3889));\
if (has_undefined_bit(&EQ_u10_u1_3889)) {fprintf(stderr, "Error: variable EQ_u10_u1_3889 has undefined value (%s) at test point.\n", to_string(&EQ_u10_u1_3889));assert(0);} \

if (bit_vector_to_uint64(0, &EQ_u10_u1_3889)) { 
// 			$call readSDHCRegisters (37  ) (tempPresentState_1_4 ) 
_sdhc_daemon_call_stmt_3892_c_macro_; 
// 			$call writeSDHCRegisters (37  (tempPresentState_1_4 & _hf7 ) ) () 
_sdhc_daemon_call_stmt_3897_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(konst_3900,1);\
bit_vector_clear(&konst_3900);\
konst_3900.val.byte_array[0] = 1;\
__declare_static_bit_vector(EQ_u1_u1_3901,1);\
bit_vector_clear(&konst_3900);\
konst_3900.val.byte_array[0] = 1;\
bit_vector_equal(0, &(singleMultipleReadBlock), &(konst_3900), &(EQ_u1_u1_3901));\
if (has_undefined_bit(&EQ_u1_u1_3901)) {fprintf(stderr, "Error: variable EQ_u1_u1_3901 has undefined value (%s) at test point.\n", to_string(&EQ_u1_u1_3901));assert(0);} \

if (bit_vector_to_uint64(0, &EQ_u1_u1_3901)) { 
// 			readBlockCountEnable := ((  $bitreduce |  (transferRegVal2 & _h02 ) ) & singleMultipleBlock) $buffering 1// bits of buffering = 1. 
_sdhc_daemon_assign_stmt_3909_c_macro_; 
// merge  file .Aa/sdhc.linked.aa, line 1345
_sdhc_daemon_merge_stmt_3910_c_preamble_macro_; 
// 				$phi E := 				  ONE_8 $on   $entry 				  next_E $on   loopBlock2 
 // type of target is $uint<8>
_sdhc_daemon_phi_stmt_3911_c_macro_; 
// 				$phi readNewBlockCount := 				  ($bitcast ($uint<16>) 0  ) $on   $entry 				  readBlockCount $on   loopBlock2 
 // type of target is $uint<16>
_sdhc_daemon_phi_stmt_3915_c_macro_; 
_sdhc_daemon_merge_stmt_3910_c_postamble_macro_; 
// 			$call readSDHCRegisters ((6  + E) ) (readnewBlockCountTemp ) 
_sdhc_daemon_call_stmt_3925_c_macro_; 
// 			$volatile readBlockCount := (( $slice readNewBlockCount 7 0 )  && readnewBlockCountTemp) $buffering 1
_sdhc_daemon_assign_stmt_3931_c_macro_; 
// 			$volatile next_E := (E - 1 ) $buffering 1
_sdhc_daemon_assign_stmt_3936_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(konst_3939,8);\
bit_vector_clear(&konst_3939);\
__declare_static_bit_vector(NEQ_u8_u1_3940,1);\
bit_vector_clear(&konst_3939);\
bit_vector_not_equal(0, &(E), &(konst_3939), &NEQ_u8_u1_3940);\
if (has_undefined_bit(&NEQ_u8_u1_3940)) {fprintf(stderr, "Error: variable NEQ_u8_u1_3940 has undefined value (%s) at test point.\n", to_string(&NEQ_u8_u1_3940));assert(0);} \

if (bit_vector_to_uint64(0, &NEQ_u8_u1_3940)) { 
/* 			$place[loopBlock2]
...
_sdhc_daemon_assign_stmt_3952_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(konst_3955,16);\
bit_vector_clear(&konst_3955);\
__declare_static_bit_vector(NEQ_u16_u1_3956,1);\
bit_vector_clear(&konst_3955);\
bit_vector_not_equal(0, &(readBlockCount), &(konst_3955), &NEQ_u16_u1_3956);\
if (has_undefined_bit(&NEQ_u16_u1_3956)) {fprintf(stderr, "Error: variable NEQ_u16_u1_3956 has undefined value (%s) at test point.\n", to_string(&NEQ_u16_u1_3956));assert(0);} \

if (bit_vector_to_uint64(0, &NEQ_u16_u1_3956)) { 
// 			newReadBlockCount := (readBlockCount - 1 ) $buffering 1// bits of buffering = 16. 
_sdhc_daemon_assign_stmt_3961_c_macro_; 
// 			$call dataRx (readLastBlock ) (dataErrorInterruptStatusVar ) 
_sdhc_daemon_call_stmt_3964_c_macro_; 
// 			dataRxEnrty1 := ZERO_1 $buffering 1// bits of buffering = 1. 
_sdhc_daemon_assign_stmt_3967_c_macro_; 
// 			dataRxEnrty2 := ONE_1 $buffering 1// bits of buffering = 1. 
_sdhc_daemon_assign_stmt_3970_c_macro_; 
// 			$call writeSDHCRegisters (7  ( $slice newReadBlockCount 15 8 )  ) () 
_sdhc_daemon_call_stmt_3974_c_macro_; 
// 			$call writeSDHCRegisters (6  ( $slice newReadBlockCount 7 0 )  ) () 
...
// 			errorInterruptFlag1 := (errorInterruptFlag1 | _h60 ) $buffering 1// bits of buffering = 8. 
_sdhc_daemon_assign_stmt_3995_c_macro_; 
} 
else {
 ;
}
...
_sdhc_daemon_call_stmt_4004_c_macro_; 
// 			$call readSDHCRegisters ((address + 1 ) ) (readTemp2 ) 
_sdhc_daemon_call_stmt_4009_c_macro_; 
// 			$call readSDHCRegisters ((address + 2 ) ) (readTemp1 ) 
_sdhc_daemon_call_stmt_4014_c_macro_; 
...
_sdhc_daemon_assign_stmt_4073_c_macro_; 
...
_sdhc_daemon_assign_stmt_4146_c_macro_; 
// 		$call readSDHCRegisters ((52  + S) ) (normalInterruptEnableRegTemp ) 
_sdhc_daemon_call_stmt_4151_c_macro_; 
// 		$volatile normalInterruptEnableReg := (( $slice readNormalInterruptEnableReg 7 0 )  && normalInterruptEnableRegTemp) $buffering 1
_sdhc_daemon_assign_stmt_4157_c_macro_; 
// 		$call readSDHCRegisters ((44  + S) ) (clockControlRegTemp ) 
_sdhc_daemon_call_stmt_4162_c_macro_; 
// 		$volatile next_S := (S - 1 ) $buffering 1
_sdhc_daemon_assign_stmt_4167_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 0
__declare_static_bit_vector(konst_4170,8);\
bit_vector_clear(&konst_4170);\
__declare_static_bit_vector(NEQ_u8_u1_4171,1);\
bit_vector_clear(&konst_4170);\
bit_vector_not_equal(0, &(S), &(konst_4170), &NEQ_u8_u1_4171);\
if (has_undefined_bit(&NEQ_u8_u1_4171)) {fprintf(stderr, "Error: variable NEQ_u8_u1_4171 has undefined value (%s) at test point.\n", to_string(&NEQ_u8_u1_4171));assert(0);} \

if (bit_vector_to_uint64(0, &NEQ_u8_u1_4171)) { 
/* 			$place[loopError]
*/  goto loopError_3433;
} 
else {
...
_sdhc_daemon_assign_stmt_4225_c_macro_; 
// 		$call writeSDHCRegisters (51  tempErrorReg1 ) () 
_sdhc_daemon_call_stmt_4228_c_macro_; 
// 		errorInterruptBit := (((  $bitreduce |  tempErrorReg0 ) | (  $bitreduce |  tempErrorReg1 )) && ($bitcast ($uint<7>) 0  )) $buffering 1// bits of buffering = 8. 
_sdhc_daemon_assign_stmt_4238_c_macro_; 
// 		$volatile checkInterruptEnable := ((  $bitreduce |  normalInterruptEnableVal0 ) | (  $bitreduce |  normalInterruptEnableVal1 )) $buffering 1
_sdhc_daemon_assign_stmt_4245_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 1423
__declare_static_bit_vector(konst_4248,1);\
bit_vector_clear(&konst_4248);\
konst_4248.val.byte_array[0] = 1;\
__declare_static_bit_vector(EQ_u1_u1_4249,1);\
bit_vector_clear(&konst_4248);\
konst_4248.val.byte_array[0] = 1;\
bit_vector_equal(0, &(checkInterruptEnable), &(konst_4248), &(EQ_u1_u1_4249));\
if (has_undefined_bit(&EQ_u1_u1_4249)) {fprintf(stderr, "Error: variable EQ_u1_u1_4249 has undefined value (%s) at test point.\n", to_string(&EQ_u1_u1_4249));assert(0);} \

if (bit_vector_to_uint64(0, &EQ_u1_u1_4249)) { 
...
_sdhc_daemon_assign_stmt_4266_c_macro_; 
// 			$call writeSDHCRegisters (48  interrupt ) () 
_sdhc_daemon_call_stmt_4269_c_macro_; 
// 			$call writeSDHCRegisters (49  errorInterruptBit ) () 
_sdhc_daemon_call_stmt_4272_c_macro_; 
...
_sdhc_daemon_stmt_4308_c_macro_; 
// 		$call readSDHCRegisters (44  ) (clockControlVal0 ) 
_sdhc_daemon_call_stmt_4311_c_macro_; 
// 		$call readSDHCRegisters (45  ) (clockControlVal1 ) 
_sdhc_daemon_call_stmt_4314_c_macro_; 
// 		$volatile frequencyDivider := (( $slice clockControlVal0 7 6 )  && clockControlVal1) $buffering 1
_sdhc_daemon_assign_stmt_4320_c_macro_; 
// if statement :  file .Aa/sdhc.linked.aa, line 1439
__declare_static_bit_vector(konst_4323,10);\
bit_vector_clear(&konst_4323);\
__declare_static_bit_vector(EQ_u10_u1_4324,1);\
bit_vector_clear(&konst_4323);\
bit_vector_equal(0, &(frequencyDivider), &(konst_4323), &(EQ_u10_u1_4324));\
if (has_undefined_bit(&EQ_u10_u1_4324)) {fprintf(stderr, "Error: variable EQ_u10_u1_4324 has undefined value (%s) at test point.\n", to_string(&EQ_u10_u1_4324));assert(0);} \

if (bit_vector_to_uint64(0, &EQ_u10_u1_4324)) { 
// 			frequencySelect := ($bitcast ($uint<20>) 2  ) $buffering 1// bits of buffering = 20. 
_sdhc_daemon_assign_stmt_4328_c_macro_; 
} 
else {
// 			frequencySelect := (($bitcast ($uint<20>) frequencyDivider ) * 2 ) $buffering 1// bits of buffering = 20. 
_sdhc_daemon_assign_stmt_4335_c_macro_; 
}
...
_sdhc_daemon_call_stmt_4349_c_macro_; 
// 		sdClkEnable := (tempclockcontroller [] 2 ) $buffering 1// bits of buffering = 1. 
_sdhc_daemon_assign_stmt_4354_c_macro_; 
/* 		$place[loopback]
*/  goto loopback_3433;
